...
public class SList<T>  {
  ...
  /** Delete the Node following <code>u</code> in this SList.
    * We assume <code>u</code> is not null and not the tail.
...
//    }
  ...
  public boolean delete(T e) {
    ...
    while (leader != null && !e.equals(leader.val)) {
  ...
  public SList<Integer> locationsOf(T e) {
    ...
    int count = 0;
    while (it.hasNext()) {
      if (it.next().equals(e)) ans.add(count);
      count++;
    }
    return ans;
  }
